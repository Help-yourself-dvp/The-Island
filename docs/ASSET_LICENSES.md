...
- **Evidence:** `models/Stylized Nature MegaKit[Standard]/License_Standard.txt`
...
- **License:** CC0 1.0 Universal / Public Domain Dedication
- **Evidence:** `models/Ultimate Fantasy RTS - Aug 2022/License.txt`
- **Note:** the bundled license header says “Ultimate Platformer Pack”, apparently a copy/paste error; it still explicitly identifies Quaternius and grants CC0 1.0. The pack's official source is also represented as CC0.
- **Retrieved:** user-provided source, audited 2026-08-21
...
No attribution is legally required by the selected CC0 assets. Credits are retained voluntarily for provenance and respect for their creators.
